...
test("PlayerStore", ()=>{
    let playerUpgrades : PlayerUpgrade[] = [
        {name: "up1", cost: 5, description: "basic upgrade", multiplier: 1.03, purchasedCount: 5}, //5.15 
        {name: "up1", cost: 5, description: "basic upgrade", multiplier: 1.03, purchasedCount: 5}, //5.15 
        {name: "up1", cost: 5, description: "basic upgrade", multiplier: 1.03, purchasedCount: 5}, //5.15  //20.6
        {name: "up1", cost: 5, description: "basic upgrade", multiplier: 1.03, purchasedCount: 5}  //5.15 
    ]
